  ...
  showResultsModal({
    ...
    contentAugmenter: function (contentElement) {
      ...
      errorStartingElement.innerHTML =
        "An error occurred submitting contact us submission";
  ...
  if (response.ok) {
    response.json().then(function (content) {
      if (content.success) {
        ...
        console.error(
          "Error occurred when submitting Contact Us page: ",
          content
        );
        hideResultsModal();
    ...
    console.error("Error occurred when submitting Contact Us page: ", response);
    hideResultsModal();
...
const submitFormData = function (e) {
  ...
  fetch(formSubmissionUrl, {
    ...
    .catch(function (error) {
      console.error(
        "Unexpected error occurred when submitting the contact us submission: ",
        error
      );
      hideResultsModal();
      showErrorModal("", false);
...
const handleFormData = function (e) {
  ...
  if (fullname === "") {
    showError(fullnameInput, "Full Name field is mandatory.");
  }
  if (phone === "") {
    showError(phoneVal, "Phone Number field is mandatory.");
  }
  if (!emailPattern.test(email)) {
    showError(emailInput, "Email Address field is mandatory.");
  }
