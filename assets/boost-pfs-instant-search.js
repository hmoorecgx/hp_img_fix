...
(function() {
  ...
  SearchInput.prototype.customizeInstantSearch = function() {
    ...
    var boostCloseSuggestionSelector = jQ('.boost-pfs-search-btn-close-suggestion');
    boostCloseSuggestionSelector.on("click", function() {
      console.log("Closing...");
      var shopifyCloseSuggestionSelector = jQ('.Search__Close');
      shopifyCloseSuggestionSelector.click();
    });
  };
